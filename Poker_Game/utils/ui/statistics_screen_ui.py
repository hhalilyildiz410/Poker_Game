...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(
            self.Summary_Table.sizePolicy().hasHeightForWidth())
        ...
        self.best_hands_btn.setStyleSheet(
            "background-color: rgb(204, 204, 204);")
